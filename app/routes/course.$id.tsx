...
export default function CourseDetails() {
  ...
  const lessons = [
    { id: 'lesson-1', title: '01. Introduction to Go Concurrency', duration: '12:45', isCompleted: true, isLocked: false, isActive: currentLesson === 'lesson-1', video: 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8' },
    { id: 'lesson-2', title: '02. Understanding Channels and Select', duration: '18:20', isCompleted: false, isLocked: false, isActive: currentLesson === 'lesson-2', video: 'https://bitdash-a.akamaihd.net/content/MI201109210084_1/m3u8s/f08e80da-bf1d-4e3d-8899-f0f6155f6efa.m3u8' },
    { id: 'lesson-3', title: '03. Advanced Worker Pool Patterns', duration: '24:15', isCompleted: false, isLocked: false, isActive: currentLesson === 'lesson-3', video: 'https://bitdash-a.akamaihd.net/content/sintel/hls/playlist.m3u8' },
    { id: 'lesson-4', title: '04. Real-time Systems with WebSockets', duration: '32:10', isCompleted: false, isLocked: true, isActive: currentLesson === 'lesson-4', video: '' },
    { id: 'lesson-5', title: '05. PDF Manipulation at Scale', duration: '15:50', isCompleted: false, isLocked: true, isActive: currentLesson === 'lesson-5', video: '' },
  ];
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
              <div className="space-y-6 max-w-4xl">
                ...
                <h1 className="text-4xl lg:text-6xl font-black tracking-tight leading-[1.1] text-white">
                  Mastering Go <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400">Concurrency</span> Patterns
                </h1>
                <p className="text-slate-300 text-xl leading-relaxed max-w-3xl font-medium opacity-90">
                  Build highly scalable, industrial-grade systems using goroutines, channels, and advanced synchronization architectures.
                </p>
              </div>
            ...
            <div className="bg-white rounded-[32px] p-8 shadow-xl shadow-slate-200/50 border border-slate-100">
              ...
              <div className="space-y-6">
                ...
                <p className="text-slate-600 leading-relaxed">
                  This is a prototype view. In the final version, the video content is served via adaptive HLS streaming from Cloudflare R2, with progress synchronized in real-time via WebSockets to a Go backend.
                </p>
                ...
                <div className="flex items-center justify-between opacity-50 cursor-not-allowed">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-slate-500 font-medium italic">Backend unavailable in prototype</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-blue-600 rounded-[32px] p-8 text-white shadow-xl shadow-blue-500/20">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center text-sm border-b border-white/10 pb-3">
                  <span className="text-blue-100 opacity-80">Prototype Mode</span>
                  <span className="flex items-center gap-2 font-mono">
                    Stand-alone <span className="w-2 h-2 rounded-full bg-green-400"></span>
                  </span>
                </div>
                <div className="flex justify-between items-center text-sm">
                  <span className="text-blue-100 opacity-80">Frontend Frame</span>
                  <span className="font-mono text-[10px]">Remix Framework</span>
                </div>
              </div>
            </div>
          </div>
